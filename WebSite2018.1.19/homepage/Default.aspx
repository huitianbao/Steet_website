    ...
    <form id="form1" runat="server">
        ...
        <asp:LinqDataSource ID="ldsHotRolling" runat="server" ContextTypeName="FlapperDataContext" EntityTypeName="" TableName="HotRolling">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td class="auto-style2">
        <asp:GridView ID="gvHotRolling" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" Width="510px" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Left">
